...
#les_filename = "wave_averaged_diurnal_boundary_layer_les_Nx256_Nz256_averages.jld2"
...
cr = contourf!(axb_les, t_les ./ hours, z_les, interior(Bt_les, 1, 1, :, :)', levels=12, colormap=:viridis)
cr = contourf!(axb_sc4, t_sc4 ./ hours, z_sc4, interior(Bt_sc4, 1, 1, :, :)', levels=12, colormap=:viridis)
