...
bounds_library[:Cˢ]   = (0.0, 8.0)
bounds_library[:Cᵇ]   = (0.0, 8.0)

bounds_library[:CˡᵒD] = (0.0, 8.0)
bounds_library[:Cˡᵒu] = (0.0, 8.0)
bounds_library[:Cˡᵒc] = (0.0, 8.0)
bounds_library[:Cˡᵒe] = (0.0, 8.0)

bounds_library[:Cʰⁱc] = (0.0, 8.0)
bounds_library[:Cʰⁱu] = (0.0, 8.0)
